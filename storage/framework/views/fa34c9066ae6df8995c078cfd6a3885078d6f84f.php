<div id="accordion">
        <div class="card">
          ...
          <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
            <div class="card-body">
              <a href="<?php echo e(url('/create/rooms')); ?>" >Add Room</a><br>
              <a href="<?php echo e(url('/create/roomtype')); ?>">Add Room Type</a><br>
              <a href="<?php echo e(url('/checkin/guest')); ?>">Check In Form</a><br>
            </div>
          </div>
        </div>
        <div class="card">
